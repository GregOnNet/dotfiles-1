...
bindkey '^[b' backward-word            # Ctrl + left arrow, Option + left arrow
bindkey '^[f' forward-word             # Ctrl + right arrow, Option + right arrow
bindkey '^A' beginning-of-line         # cmd + right
bindkey '^E' end-of-line               # cmd + left
